...
namespace QuickUnity.Editor.Database.TableDefinition
{
    ...
    public class TableDefinitionEntity : EntityBase
    {
        ...
        public string EntityAutoGeneratedScriptFileName => ClassName + "Entity_AutoGenerated.cs";
        public string EntityScriptFileName => ClassName + "Entity.cs";
        public string RepositoryAutoGeneratedScriptFileName => ClassName + "Repository_AutoGenerated.cs";
        public string RepositoryScriptFileName => ClassName + "Repository.cs";
        public string DataMapperAutoGeneratedScriptFileName => ClassName + "DataMapper_AutoGenerated.cs";
