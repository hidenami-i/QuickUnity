...
namespace QuickUnity.Extensions.DotNet
{
    public static class ExIEnumerable
    {
        ...
        /// </summary>
        public static bool IsNotEmpty<T>(this IEnumerable<T> self) => !IsNullOrEmpty(self);
        ...
        public static int CountIfNullZero<T>(this IEnumerable<T> self) => self.IsNullOrEmpty() ? 0 : self.Count();
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static bool AnyIfNullFalse<T>(this IEnumerable<T> self, Func<T, bool> predicate) =>
            !self.IsNullOrEmpty() && self.Any(predicate);
        ...
        /// <summary>
        /// Returns the IEnumerable excluding the last element of IEnumerable.
        /// </summary>
