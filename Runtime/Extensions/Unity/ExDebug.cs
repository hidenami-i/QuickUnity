...
namespace QuickUnity.Extensions.Unity
{
    ...
    public static class ExDebug
    {
        ...
        public static void Log<T>(T value, string title, Object context, Color? color = null)
        {
            ...
            global::UnityEngine.Debug.Log($"<color=#{hex}>{title}{value}</color>", context);
        }
        ...
        public static void LogWarning<T>(T value, string message = null)
        {
            ...
            global::UnityEngine.Debug.LogWarningFormat("<color=#{0}>{1}{2}</color>", WarningHexColor, str,
                value.ToString());
        }
        ...
        {
            var str = string.IsNullOrEmpty(message) ? "" : $"{message} : ";
            global::UnityEngine.Debug.LogErrorFormat("<color=#{0}>{1}{2}</color>", ErrorHexColor, str,
                value.ToString());
        }
        ...
        public static void LogException(System.Exception e, string message = "")
        {
            ...
            global::UnityEngine.Debug.LogError(builder.ToString());
        }
        ...
        {
            global::UnityEngine.Debug.DrawRay(startPosition, direction.normalized * distance, color, 0, false);
        }
        ...
        {
            Log("mono used size", ExNumber.ToHumanReadableSize(Profiler.GetMonoUsedSizeLong()), null, null);
        }
        ...
        {
            global::UnityEngine.Debug.Log(GetSystemInfoToString);
        }
        ...
        public static string GetSystemInfoToString
        {
            get
            {
                ...
                builder.AppendLine(
                    $"[ScreenCurrentResolution] {Screen.currentResolution.width}×{Screen.currentResolution.height}");

                builder.AppendLine("[SupportsTextureFormat]");
                foreach (TextureFormat textureFormat in ExEnum.ToList<TextureFormat>())
                {
                    builder.AppendLine($"[{ExEnum.GetName(textureFormat)}]" +
                                       SystemInfo.SupportsTextureFormat(textureFormat));
                }
